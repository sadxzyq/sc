let handler = async (m, { conn, args, usedPrefix }) => {
    if (args.length > 0) {
        ...
        if (warning < 5) {
            ...
            conn.sendButton(ban, hiasan, '*Kamu di warn oleh moderator, makanya gak usah spam spam jing, dan sekarang kamu punya ' + (warning + 1) + ' warn. Ingat Jika kamu mendapat warn 5 kali kamu akan otomatis ke banned*', thumbWarn, [['Customer Service', usedPrefix + 'report']], null)
        } else if (warning == 5) {
